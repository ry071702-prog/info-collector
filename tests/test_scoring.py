...
def test_video_trend_score_growing_with_rate():
    # 9h で 100k views → ~11k/hour → 70 (boundary buffer prevents microsecond flakiness)
...
def test_final_priority_S_threshold():
    # S importance + 24h freshness + streamer boost → composite >= 80
    # weight_importance=0.5, weight_freshness=0.2, weight_streamer=0.15 → 50+20+15=85
